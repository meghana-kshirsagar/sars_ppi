...
for split in range(0,5):
    ...
    y_train = np.vstack((y_train,y_train_cov))
    X_train = np.row_stack((X_train, X_train_cov))
    print(y_train.shape)
    print(X_train.shape)
    ...
    # save model
    #save_model(clf,format("models/ebm_humanpartners_1to1_no3mer_nonorm_noint_split%d_mtl.pkl" % split))
